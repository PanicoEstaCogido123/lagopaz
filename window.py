...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lblTitulo.setGeometry(QtCore.QRect(460, 210, 111, 20))
        self.lblTitulo.setObjectName("lblTitulo")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(324, 240, 381, 80))
        ...
        self.gridLayout.addWidget(self.txtDatos, 0, 0, 1, 1)
