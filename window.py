...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnAceptar.setGeometry(QtCore.QRect(423, 290, 75, 23))
        self.btnAceptar.setObjectName("btnAceptar")
        self.btnSalir = QtWidgets.QPushButton(self.centralwidget)
        self.btnSalir.setGeometry(QtCore.QRect(523, 290, 75, 23))
        self.btnSalir.setObjectName("btnSalir")
        self.SeparadorInferior = QtWidgets.QFrame(self.centralwidget)
        self.SeparadorInferior.setGeometry(QtCore.QRect(10, 270, 1011, 20))
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 50, 991, 221))
        self.groupBox.setObjectName("groupBox")
        self.layoutWidget = QtWidgets.QWidget(self.groupBox)
        self.layoutWidget.setGeometry(QtCore.QRect(310, 60, 361, 22))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(310, 150, 361, 19))
        ...
        self.rbtMasc = QtWidgets.QRadioButton(self.layoutWidget1)
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(280, 21, 421, 26))
        ...
        self.lblValidoDNI = QtWidgets.QLabel(self.layoutWidget2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(310, 90, 361, 22))
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(280, 180, 421, 19))
        self.layoutWidget4.setObjectName("layoutWidget4")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.layoutWidget4)
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.lblFormaDePago = QtWidgets.QLabel(self.layoutWidget4)
        ...
        self.chkTrans = QtWidgets.QCheckBox(self.layoutWidget4)
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(280, 120, 421, 22))
        ...
        self.tabClientes = QtWidgets.QTableView(self.centralwidget)
        self.tabClientes.setGeometry(QtCore.QRect(140, 330, 741, 271))
